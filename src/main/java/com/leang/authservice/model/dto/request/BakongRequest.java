...
public record BakongRequest(
    ...
    public BakongRequest {
        ...
        merchantNameAlternateLanguage = merchantNameAlternateLanguage == null ? "MERCHANT" : merchantNameAlternateLanguage;
        merchantCityAlternateLanguage = merchantCityAlternateLanguage == null ? "PHNOM PENH" : merchantCityAlternateLanguage;
    }
}
